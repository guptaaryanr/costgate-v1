...
Citation metadata is in `CITATION.cff`; Zenodo metadata is in `.zenodo.json`.
The final DOI should be generated by Zenodo from the `v1.0.0` GitHub release.
Do not cite a DOI until Zenodo has archived the release and assigned one.
