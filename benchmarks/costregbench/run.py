...
def _write_readme(out_root: Path) -> None:
    release_tag = f"v{costgate.__version__}"
    release_kind = "release candidate" if "rc" in costgate.__version__ else "release"
    lines = [
        f"# Costgate {release_tag} Frozen CostRegBench Artifact",
        "",
        (
            "This directory contains the frozen deterministic CostRegBench outputs "
            f"for the Costgate {costgate.__version__} {release_kind}."
        ),
        "",
        "## Generated By",
        "",
